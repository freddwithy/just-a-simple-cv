...
const SecondHero = () => {
    return (
        <Container>
            <div className="flex flex-col gap-y-4 items-center py-10 justify-center text-center">
                <h2 className="text-4xl font-bold text-mystic-700 text-balance">One template is all what you need</h2>
                <p className="text-gray-600 text-2xl text-pretty">Minimalist a ease to edit. Export your CV in JSON and PDF formats.</p>
